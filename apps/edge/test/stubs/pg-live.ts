...
export class Client {
  ...
  async end(): Promise<void> {
    ...
    // deferred close straddles the Durable-Object io boundary and workerd
    // kills every subsequent write on the same hyperdrive proxy socket.
    // (The cf-polyfill patch in patches/ makes this close the read pump cleanly.)
