/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: bedd31c7376484d23c65b6d2ff8ee924)
// Runtime types generated with workerd@1.20260921.1 2026-09-21
interface __BaseEnv_Env {
	X402_MODE: "shadow" | "live";
	X402_NETWORK: "eip155:84532" | "eip155:8453";
	X402_CHAIN_ID: "84532" | "8453";
	X402_ASSET_ADDRESS: "0x036CbD53842c5426634e7929541eC2318f3dCF7e" | "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913";
	X402_ASSET_EIP712_NAME: "USDC" | "USD Coin";
	GRANTS?: KVNamespace;
	WBA_DIR?: KVNamespace;
	...
	ORIGIN_HOST?: "musebook-web.vercel.app";
	ORIGIN_SCHEME?: "https";
	...
	FAL_WEBHOOK_JWKS_URL?: "https://rest.alpha.fal.ai/.well-known/jwks.json";
	MEDIA_WEBHOOK_VERIFY_MODE?: "enforce";
	MEDIA_LONGFORM_VIDEO_ENABLED?: "false";
	ARTIFACT_TICKET_PUBLIC_KEY?: "-----BEGIN PUBLIC KEY-----\nMCowBQYDK2VwAyEAanDeVHyUB/B96fELB/h4DPx6YMTZduNP4pqFTLl2PF8=\n-----END PUBLIC KEY-----";
	LLMS_FULL_MAX_BYTES?: "4000000";
	MUSEBOOK_BRIDGE_POLL_MAX_MS?: "25000";
	MUSEBOOK_BRIDGE_MIN_VERSION?: "1.0.0";
	CONNECTOR_EGRESS_TIMEOUT_MS?: "60000";
	CONNECTOR_EGRESS_MAX_BYTES?: "8388608";
	TELEMETRY_BATCH_MAX_EVENTS?: "16";
	TELEMETRY_IDLE_FLUSH_MS?: "5000";
	TELEMETRY_CLOCK_SKEW_MAX_MS?: "21600000";
	TELEMETRY_ANON_COOKIE_TTL_S?: "86400";
	ANALYTICS_MIN_COHORT?: "5";
	SENTRY_DSN?: "";
	SYNTHETIC_GATED_SLUG?: "seed-article-x402";
	POSTIZ_URL?: "https://postiz.musebook.dev";
	MIXER?: Service /* entrypoint SlateBuilder from musebook-worker */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "X402_MODE" | "X402_NETWORK" | "X402_CHAIN_ID" | "X402_ASSET_ADDRESS" | "X402_ASSET_EIP712_NAME" | "MUSEBOOK_LOG_LEVEL" | "ORIGIN_HOST" | "ORIGIN_SCHEME" | "CDN_HOST" | "MEDIA_HOST" | "ARTIFACT_HOST" | "ARTIFACT_ORIGIN" | "PREVIEW_CHARS" | "X402_ASSET_DECIMALS" | "X402_IDEMPOTENT_WINDOW_SECONDS" | "X402_GRANT_CACHE_TTL_S" | "WEB_BOT_AUTH_ENABLED" | "WEB_BOT_AUTH_MAX_AGE_S" | "WEB_BOT_AUTH_CLOCK_SKEW_S" | "TELEMETRY_ENABLED" | "TELEMETRY_IMPRESSION_SAMPLE" | "MUSE_SLATE_TTL_SECONDS" | "MB_RELEASE_SHA" | "CONSENT_BANNER_REGIONS" | "R2_PRESIGN_TTL_S" | "CF_ACCOUNT_ID" | "MOLTBOOK_MODE" | "MOLTBOOK_ALLOW_MOCK" | "X402_FACILITATOR_URL" | "WEB_BOT_AUTH_DIRECTORY_ALLOWLIST" | "FAL_WEBHOOK_JWKS_URL" | "MEDIA_WEBHOOK_VERIFY_MODE" | "MEDIA_LONGFORM_VIDEO_ENABLED" | "ARTIFACT_TICKET_PUBLIC_KEY" | "LLMS_FULL_MAX_BYTES" | "MUSEBOOK_BRIDGE_POLL_MAX_MS" | "MUSEBOOK_BRIDGE_MIN_VERSION" | "CONNECTOR_EGRESS_TIMEOUT_MS" | "CONNECTOR_EGRESS_MAX_BYTES" | "TELEMETRY_BATCH_MAX_EVENTS" | "TELEMETRY_IDLE_FLUSH_MS" | "TELEMETRY_CLOCK_SKEW_MAX_MS" | "TELEMETRY_ANON_COOKIE_TTL_S" | "ANALYTICS_MIN_COHORT" | "SENTRY_DSN" | "SYNTHETIC_GATED_SLUG" | "POSTIZ_URL">> {}
}
