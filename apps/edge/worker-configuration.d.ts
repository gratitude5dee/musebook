/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cf61d2e63e33556b2e80b773448e2ecb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "X402_MODE" | "X402_NETWORK" | "X402_CHAIN_ID" | "X402_ASSET_ADDRESS" | "X402_ASSET_EIP712_NAME" | "MUSEBOOK_LOG_LEVEL" | "ORIGIN_HOST" | "CDN_HOST" | "MEDIA_HOST" | "ARTIFACT_HOST" | "ARTIFACT_ORIGIN" | "PREVIEW_CHARS" | "X402_ASSET_DECIMALS" | "X402_IDEMPOTENT_WINDOW_SECONDS" | "X402_GRANT_CACHE_TTL_S" | "WEB_BOT_AUTH_ENABLED" | "WEB_BOT_AUTH_MAX_AGE_S" | "WEB_BOT_AUTH_CLOCK_SKEW_S" | "TELEMETRY_ENABLED" | "TELEMETRY_IMPRESSION_SAMPLE" | "MUSE_SLATE_TTL_SECONDS" | "MB_RELEASE_SHA" | "CONSENT_BANNER_REGIONS" | "R2_PRESIGN_TTL_S" | "MOLTBOOK_MODE" | "MOLTBOOK_ALLOW_MOCK" | "X402_FACILITATOR_URL" | "WEB_BOT_AUTH_DIRECTORY_ALLOWLIST" | "FAL_WEBHOOK_JWKS_URL" | "MEDIA_WEBHOOK_VERIFY_MODE" | "MEDIA_LONGFORM_VIDEO_ENABLED" | "ARTIFACT_TICKET_PUBLIC_KEY" | "LLMS_FULL_MAX_BYTES" | "MUSEBOOK_BRIDGE_POLL_MAX_MS" | "MUSEBOOK_BRIDGE_MIN_VERSION" | "TELEMETRY_BATCH_MAX_EVENTS" | "TELEMETRY_IDLE_FLUSH_MS" | "TELEMETRY_CLOCK_SKEW_MAX_MS" | "TELEMETRY_ANON_COOKIE_TTL_S" | "ANALYTICS_MIN_COHORT" | "SENTRY_DSN" | "SYNTHETIC_GATED_SLUG">> {}
}
