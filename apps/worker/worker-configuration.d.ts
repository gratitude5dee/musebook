/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1f9c44756bde95e6a6d0616340e1048f)
...
interface __BaseEnv_Env {
	...
	CLASSIFY_PROVIDER: "gateway";
	CLASSIFY_MODEL: "anthropic/claude-haiku-4.5";
	CLASSIFY_DAILY_TOKEN_BUDGET: "2000000";
	...
	CONNECTOR_EGRESS_MAX_BYTES: "8388608";
	CONNECTOR_CODEX_AGENTS_API_ENABLED: "false";
	REGISTRY_REVIEW_NOTIFY_EMAIL: "registry@musebook.dev";
	MUSE_RANKER_MODEL_ID: "muse-heuristic-2026-10";
	MUSE_RANKER_ONNX_PATH: "";
	MUSE_RANKER_MODEL_URL: "";
	MUSE_DIVERSITY_IMPL: "none";
	MUSE_RANKER_TIMEOUT_MS: "250";
	MUSE_RETRIEVAL_NEW_USER_ACTION_THRESHOLD: "20";
	MUSE_RETRIEVAL_NEW_USER_INDEX_ID: "cohort-centroid";
	MUSE_RANKER_NEW_USER_ACTION_THRESHOLD: "50";
	MUSE_TOPK_CANDIDATES: "100";
	MUSE_MAX_CANDIDATES_PER_SOURCE: "400";
	MUSE_MIN_CANDIDATES: "30";
	MUSE_SOURCE_TIMEOUT_MS: "180";
	MUSE_HYDRATOR_TIMEOUT_MS: "150";
	MUSE_SCORER_TIMEOUT_MS: "250";
	MUSE_SLATE_TTL_SECONDS: "900";
	MUSE_SCORE_CACHE_TTL_SECONDS: "600";
	MUSE_WEIGHTS_CACHE_TTL_SECONDS: "30";
	MUSE_HNSW_EF_SEARCH: "200";
	MUSE_BLOOM_CAPACITY: "10000";
	MUSE_BLOOM_ERROR_RATE: "0.01";
	MUSE_BLOOM_ROTATION: "weekly";
	MUSE_BLOOM_BYPASS_REMOVAL_RATIO: "0.70";
	MUSE_SEEN_EXACT_WINDOW: "500";
	MUSE_AGENT_CRAWL_MAX_PER_POST_PER_AGENT_PER_DAY: "3";
	MUSE_COLDSTART_ENABLED: "true";
	MUSE_COLDSTART_FOLLOWER_CAP: "5000";
	MUSE_COLDSTART_IMPRESSION_THRESHOLD: "1000";
	MUSE_COLDSTART_MAX_POST_AGE_MS: "172800000";
	MUSE_COLDSTART_MAX_POSITION_RATIO: "0.5";
	...
	MUSE_VIEWER_EMBED_INTERVAL_H: "24";
	MUSE_MIXER_WARM_VIEWER_HOURS: "24";
	EMBEDDING_MODEL: "text-embedding-3-small";
	EMBEDDING_DIMENSIONS: "1536";
	TELEMETRY_ENABLED: "true";
	TELEMETRY_IMPRESSION_SAMPLE: "1.0";
	TELEMETRY_ANON_ID_RETENTION_DAYS: "30";
	TELEMETRY_IP_HASH_RETENTION_DAYS: "7";
	TELEMETRY_IMPRESSION_COMPACT_DAYS: "120";
	TELEMETRY_HUMAN_RETENTION_DAYS: "400";
	TELEMETRY_AGENT_RETENTION_DAYS: "90";
	ANALYTICS_MIN_COHORT: "5";
	ANALYTICS_AGENT_BREAKDOWN_CACHE_S: "900";
	SENTRY_DSN: "";
	ALERT_WEBHOOK_URL: "";
	SYNTHETIC_GATED_SLUG: "seed-article-x402";
	ORIGIN_HOST: "";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MUSEBOOK_LOG_LEVEL" | "DISTRIBUTION_ENABLED" | "OUTBOX_SWEEP_MAX_ROWS" | "MUSE_WEIGHTS_VERSION" | "MUSE_RANKER_IMPL" | "CDN_HOST" | "MEDIA_HOST" | "MB_RELEASE_SHA" | "CF_ACCOUNT_ID" | "THIRDWEB_SERVER_WALLET_ADDRESS" | "MOLTBOOK_MODE" | "MOLTBOOK_ALLOW_MOCK" | "X402_MODE" | "X402_NETWORK" | "X402_CHAIN_ID" | "X402_RPC_URL" | "X402_ASSET_ADDRESS" | "X402_ASSET_EIP712_NAME" | "X402_ASSET_DECIMALS" | "X402_FACILITATOR_URL" | "X402_PAYOUT_NETWORK" | "X402_PAYOUT_BATCH_MIN_ATOMIC" | "X402_PAYOUT_NET_BPS" | "APECHAIN_PAYOUT_ENABLED" | "APECHAIN_RPC_URL" | "APECHAIN_PAYOUT_ASSET" | "TYPESAFE_BASE_URL" | "TYPESAFE_DEFAULT_MODEL" | "TYPESAFE_LOG_LEVEL" | "CLASSIFY_TAXONOMY_MODE" | "CLASSIFY_PROVIDER" | "CLASSIFY_MODEL" | "CLASSIFY_DAILY_TOKEN_BUDGET" | "GEN_MODEL" | "REFORMAT_MODEL" | "REFORMAT_MAX_REPAIRS" | "POSTIZ_URL" | "POSTIZ_MEDIA_DOMAIN" | "MEDIA_WEBHOOK_BASE_URL" | "MEDIA_BACKEND_REPLICATE_ENABLED" | "MEDIA_LONGFORM_VIDEO_ENABLED" | "MB_INTERNAL_KEY_ID" | "MB_INTERNAL_PUBLIC_KEYS" | "MB_INTERNAL_MAX_SKEW_S" | "CONNECTOR_CRED_KEY_ID" | "CONNECTOR_EGRESS_TIMEOUT_MS" | "CONNECTOR_EGRESS_MAX_BYTES" | "CONNECTOR_CODEX_AGENTS_API_ENABLED" | "REGISTRY_REVIEW_NOTIFY_EMAIL" | "MUSE_RANKER_MODEL_ID" | "MUSE_RANKER_ONNX_PATH" | "MUSE_RANKER_MODEL_URL" | "MUSE_DIVERSITY_IMPL" | "MUSE_RANKER_TIMEOUT_MS" | "MUSE_RETRIEVAL_NEW_USER_ACTION_THRESHOLD" | "MUSE_RETRIEVAL_NEW_USER_INDEX_ID" | "MUSE_RANKER_NEW_USER_ACTION_THRESHOLD" | "MUSE_TOPK_CANDIDATES" | "MUSE_MAX_CANDIDATES_PER_SOURCE" | "MUSE_MIN_CANDIDATES" | "MUSE_SOURCE_TIMEOUT_MS" | "MUSE_HYDRATOR_TIMEOUT_MS" | "MUSE_SCORER_TIMEOUT_MS" | "MUSE_SLATE_TTL_SECONDS" | "MUSE_SCORE_CACHE_TTL_SECONDS" | "MUSE_WEIGHTS_CACHE_TTL_SECONDS" | "MUSE_HNSW_EF_SEARCH" | "MUSE_BLOOM_CAPACITY" | "MUSE_BLOOM_ERROR_RATE" | "MUSE_BLOOM_ROTATION" | "MUSE_BLOOM_BYPASS_REMOVAL_RATIO" | "MUSE_SEEN_EXACT_WINDOW" | "MUSE_AGENT_CRAWL_MAX_PER_POST_PER_AGENT_PER_DAY" | "MUSE_COLDSTART_ENABLED" | "MUSE_COLDSTART_FOLLOWER_CAP" | "MUSE_COLDSTART_IMPRESSION_THRESHOLD" | "MUSE_COLDSTART_MAX_POST_AGE_MS" | "MUSE_COLDSTART_MAX_POSITION_RATIO" | "MUSE_COLDSTART_SLOT_MIN" | "MUSE_COLDSTART_SLOT_MAX" | "MUSE_COLDSTART_BETA_ALPHA0" | "MUSE_COLDSTART_BETA_BETA0" | "MUSE_COLDSTART_IMPRESSION_SCALE" | "MUSE_COLDSTART_TS_TOP_K" | "MUSE_VIEWER_EMBED_INTERVAL_H" | "MUSE_MIXER_WARM_VIEWER_HOURS" | "EMBEDDING_MODEL" | "EMBEDDING_DIMENSIONS" | "TELEMETRY_ENABLED" | "TELEMETRY_IMPRESSION_SAMPLE" | "TELEMETRY_ANON_ID_RETENTION_DAYS" | "TELEMETRY_IP_HASH_RETENTION_DAYS" | "TELEMETRY_IMPRESSION_COMPACT_DAYS" | "TELEMETRY_HUMAN_RETENTION_DAYS" | "TELEMETRY_AGENT_RETENTION_DAYS" | "ANALYTICS_MIN_COHORT" | "ANALYTICS_AGENT_BREAKDOWN_CACHE_S" | "SENTRY_DSN" | "ALERT_WEBHOOK_URL" | "SYNTHETIC_GATED_SLUG" | "ORIGIN_HOST">> {}
}
