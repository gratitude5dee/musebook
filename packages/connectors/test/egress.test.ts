...
const CORPUS: Case[] = [
  {
    ...
    allowNode: ["127.0.0.1"],
    allowWorkers: [],
    nodeError: /egress_private_address/,
    workersError: /egress_host_not_allowed/,
  },
  {
    name: "unspecified",
    url: "https://0.0.0.0/",
  ...
  {
    name: "ipv6-mapped loopback (rebinding)",
    url: "https://[::ffff:7f00:1]/",
    allowNode: ["::ffff:7f00:1", "[::ffff:7f00:1]"],
    allowWorkers: [],
    nodeError: /egress_private_address/,
    workersError: /egress_host_not_allowed/,
  },
  ...
  {
    name: "hostname resolving private (rebinding)",
    url: "https://rebind.test/",
    allowNode: ["rebind.test"],
    allowWorkers: [],
    nodeError: /egress_private_address/,
    workersError: /egress_host_not_allowed/,
  },
  {
    name: "302 to a private address",
    url: "https://ok.test/redir",
    allowNode: ["ok.test"],
    allowWorkers: ["ok.test"],
    nodeError: /egress_redirect_refused/,
    workersError: /egress_redirect_refused/,
    stub302: true,
  },
  {
    name: "embedded credentials",
    url: "https://user:pw@allowed.test/",
    allowNode: ["allowed.test"],
    allowWorkers: ["allowed.test"],
    nodeError: /egress_credentials_in_url/,
    workersError: /egress_credentials_in_url/,
  },
];
