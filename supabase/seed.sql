...
-- ── M13 §9.12 runtime weights: the `v1` family ─────────────────────────────
-- discrete = signed per-action weights; continuous = the five continuous heads;
-- gates = the §9.10 shaping params. All three live in one `weights` jsonb so a
-- tuning change is one UPDATE, never a deploy. `none` is the never-active
-- bootstrap sentinel (§9.12) — it was seeded active in 20260922091400, so the
-- one-active-per-cohort index requires flipping it off before `v1` lands.
update public.ranking_weights set is_active = false where weights_version = 'none';

insert into public.ranking_weights (weights_version, cohort, weights, is_active, notes, created_at, activated_at)
select 'v1', 'default', $$
{"discrete":{"impression":0.0,"view":0.02,"dwell":0.20,"play":0.08,"play_through":0.60,
"like":1.00,"comment":2.20,"repost":3.00,"bookmark":2.50,"share":3.00,"follow":4.00,
"remix":6.00,"fork_app":7.00,"install_app":9.00,"tip":8.00,"x402_pay":5.00,
"agent_crawl":1.20,"agent_cite":2.00,"not_interested":-12.00,"mute_creator":-25.00,
"block_creator":-60.00,"report":-80.00,"not_dwelled":-1.50},
"continuous":{"dwell_time_s":0.06,"watch_time_ms":0.000004,"scroll_depth":0.30,
"active_seconds_5m":0.01,"tip_amount_usdc":0.50},
"gates":{"MinMediaDurationMs":5000,"EnablePlayThroughDurationCheck":true,
"NegativeScoresOffset":100.0,"PostUnexploredWeight":0.35,
"EnableMultiplicativePostUnexplored":false,"MultiplicativePostUnexploredAlpha":0.15,
"BidirectionalFollowCommentWeightBoost":1.35,"BidirectionalFollowDwellWeightBoost":1.20,
"AgentAuthoredMultiplier":1.00,"CreatorDiversityDecayFactor":0.80,"CreatorDiversityFloor":0.10,
"KindDiversityDecayFactor":0.85,"KindDiversityFloor":0.25,"TopKCandidatesToSelect":100,
"MixerPassBudgetMs":20000,"ReelsWatchCapMs":90000,"ReelsIdealDurationMs":20000,
"ReelsPartialWatchFraction":0.35,"ReelsWatchFloor":0.30,"ReelsMinDurationMs":2000}}
$$::jsonb, true, '§9.12 v1 hand-set priors (negativeSum=178.50, totalSum=233.30)', c.epoch, c.epoch
from seed_const c
on conflict (weights_version) do nothing;

-- §9.24: same table, different numbers — the watch-time cohort.
insert into public.ranking_weights (weights_version, cohort, weights, is_active, notes, created_at, activated_at)
select 'v1.surface-reels', 'surface:reels', $$
{"discrete":{"impression":0.0,"view":0.00,"dwell":0.00,"play":0.40,"play_through":4.00,
"like":1.00,"comment":2.20,"repost":3.00,"bookmark":2.50,"share":4.00,"follow":4.00,
"remix":6.00,"fork_app":0.00,"install_app":0.00,"tip":8.00,"x402_pay":5.00,
"agent_crawl":0.40,"agent_cite":1.00,"not_interested":-12.00,"mute_creator":-25.00,
"block_creator":-60.00,"report":-80.00,"not_dwelled":-3.00},
"continuous":{"dwell_time_s":0.00,"watch_time_ms":0.000060,"scroll_depth":0.00,
"active_seconds_5m":0.02,"tip_amount_usdc":0.50},
"gates":{"MinMediaDurationMs":5000,"EnablePlayThroughDurationCheck":true,
"NegativeScoresOffset":100.0,"PostUnexploredWeight":0.35,
"EnableMultiplicativePostUnexplored":false,"MultiplicativePostUnexploredAlpha":0.15,
"BidirectionalFollowCommentWeightBoost":1.35,"BidirectionalFollowDwellWeightBoost":1.20,
"AgentAuthoredMultiplier":1.00,"CreatorDiversityDecayFactor":0.80,"CreatorDiversityFloor":0.10,
"KindDiversityDecayFactor":0.85,"KindDiversityFloor":1.0,"TopKCandidatesToSelect":100,
"MixerPassBudgetMs":20000,"ReelsWatchCapMs":90000,"ReelsIdealDurationMs":20000,
"ReelsPartialWatchFraction":0.35,"ReelsWatchFloor":0.30,"ReelsMinDurationMs":2000}}
$$::jsonb, true, '§9.24 watch-time cohort; KindDiversityFloor 1.0 (two kinds make the axis inert)', c.epoch, c.epoch
from seed_const c
on conflict (weights_version) do nothing;

-- §9.15: HeuristicMuseRanker's logistic priors — the `heuristic` key carries the
-- coefficient map verbatim (HeuristicCoefficients shape), discrete/continuous
-- stay empty because this row is read by the ranker, not the weights loader.
insert into public.ranking_weights (weights_version, cohort, weights, is_active, notes, created_at, activated_at)
select 'v1.model-heuristic', 'model:heuristic', $$
{"discrete":{},"continuous":{},"gates":{},
"heuristic":{
"impression":{"intercept":1.9,"coefs":{}},
"view":{"intercept":-1.8,"coefs":{"recencyDecay":0.6,"inNetwork":0.8,"sourceScore":1.0}},
"dwell":{"intercept":-1.2,"coefs":{"quality":1.2,"topicAffinity":0.3,"creatorAffinity":0.25,"recencyDecay":0.4}},
"play":{"intercept":-1.5,"coefs":{"kindOneHot_3":1.2,"kindOneHot_4":1.0,"quality":0.8,"recencyDecay":0.3}},
"play_through":{"intercept":-1.9,"coefs":{"completionRate24h":1.6,"quality":0.9,"durationBucket_5":-0.4,"replays24hLog":0.1}},
"like":{"intercept":-2.2,"coefs":{"quality":1.4,"qAgentValue":0.6,"creatorAffinity":0.5,"topicAffinity":0.25,"inNetwork":0.6,"mutualFollow":0.4,"likesLog":0.12,"engagements24hLog":0.08}},
"comment":{"intercept":-3.2,"coefs":{"quality":1.0,"creatorAffinity":0.45,"inNetwork":0.7,"mutualFollow":0.5,"engagements24hLog":0.1}},
"repost":{"intercept":-3.4,"coefs":{"quality":1.1,"repostsLog":0.15,"engagementVelocity":0.05,"engagements24hLog":0.1}},
"bookmark":{"intercept":-2.9,"coefs":{"quality":1.3,"qAgentValue":0.8,"bookmarksLog":0.12,"embSimViewer":0.7}},
"share":{"intercept":-3.0,"coefs":{"quality":0.9,"engagementVelocity":0.05,"engagements24hLog":0.1}},
"follow":{"intercept":-3.8,"coefs":{"quality":0.8,"creatorAffinity":0.3,"embSimViewer":0.4,"inNetwork":-0.5}},
"remix":{"intercept":-4.2,"coefs":{"quality":1.0,"isRemixOfEngaged":1.5,"kindOneHot_5":0.5,"kindOneHot_6":0.5}},
"fork_app":{"intercept":-4.5,"coefs":{"kindOneHot_5":1.4,"kindOneHot_6":1.4,"quality":0.8,"forksLog":0.15}},
...
"x402_pay":{"intercept":-4.6,"coefs":{"accessOneHot_2":1.2,"paidFetchesLog":0.2,"embSimViewer":0.6,"quality":0.7}},
"agent_crawl":{"intercept":-3.2,"coefs":{"signedAgentFetches24hLog":0.25,"accessOneHot_2":0.5}},
"agent_cite":{"intercept":-4.0,"coefs":{"signedAgentFetches24hLog":0.2,"quality":0.7}},
"not_interested":{"intercept":-4.2,"coefs":{"pUnsafe":1.4,"embSimViewer":-0.8,"topicAffinity":-0.2}},
"mute_creator":{"intercept":-5.2,"coefs":{"pUnsafe":1.6,"creatorAffinity":-0.4}},
"block_creator":{"intercept":-5.6,"coefs":{"pUnsafe":1.8}},
"report":{"intercept":-6.0,"coefs":{"pUnsafe":2.0,"quality":-1.0}},
"not_dwelled":{"intercept":-0.6,"coefs":{"quality":-1.0,"recencyDecay":-0.5,"embSimViewer":-0.6,"sourceScore":-0.6}},
"continuous":{"dwell_time_s":{"mean":6.0,"scale":4.0},"watch_time_ms":{"mean":8000,"scale":12000},
"scroll_depth":{"mean":0.45,"scale":0.2},"active_seconds_5m":{"mean":18,"scale":12},
"tip_amount_usdc":{"mean":0,"scale":0.5}}}}
$$::jsonb, true, '§9.15 v1.0 logistic priors, verbatim HeuristicCoefficients', c.epoch, c.epoch
from seed_const c
on conflict (weights_version) do nothing;
...
select 'bbbbbbbb-bbbb-4bbb-8bbb-000000000002'::uuid, '11111111-1111-4111-8111-000000000003'::uuid, 'bbbbbbbb-bbbb-4bbb-8bbb-000000000001'::uuid, '33333333-3333-4333-8333-000000000001'::uuid,
       'active'::delegation_state, '{feed:read,post:read,post:write,media:generate}'::text[],
